...
namespace odb
{
        ...
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer_type = MYSQL_TYPE_LONGLONG;
    b[n].is_unsigned = 1;
    b[n].buffer = &i._num_value;
    b[n].is_null = &i._num_null;
    n++;
  ...
  query_statement (const query_base_type& q)
  {
    ...
    r += " LEFT JOIN `Class` ON";
    // From student.hxx:77:33
    r += query_columns::Student::classId == query_columns::Class::id;
  ...
  bool access::view_traits_impl< ::allName, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
    ODB_POTENTIALLY_UNUSED (i);
  ...
  void access::view_traits_impl< ::allName, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i)
  {
    using namespace mysql;
  ...
  access::view_traits_impl< ::allName, id_mysql >::query_base_type
  access::view_traits_impl< ::allName, id_mysql >::
  query_statement (const query_base_type& q)
  {
    query_base_type r (
      // From student.hxx:99:17
      "select name from Student " + (q.empty () ? query_base_type::true_expr : q));
    return r;
  }

  result< access::view_traits_impl< ::allName, id_mysql >::view_type >
  access::view_traits_impl< ::allName, id_mysql >::
  query (database& db, const query_base_type& q)
  {
    using namespace mysql;
